...
{
 public:
  explicit DesignWrite(IdbDesign* design);
  ~DesignWrite() = default;

  IdbDesign* get_design() { return _design; }

  bool writeDesign(const char* folder);
  bool writeDesign(const std::string& folder, bool parallel = true);
