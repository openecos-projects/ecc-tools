...
class NetWireEditAdapter
{
 public:
  ...
  bool resize_regular_segment(idb::IdbDesign& design, OwnerRef owner, Rect32 current_bbox, Rect32 requested_bbox,
                              Rect32& committed_bbox) const;
  bool move_special_segment(idb::IdbDesign& design, OwnerRef owner, Rect32 current_bbox, Rect32 requested_bbox,
                            Rect32& committed_bbox) const;
  bool resize_special_segment(idb::IdbDesign& design, OwnerRef owner, Rect32 current_bbox, Rect32 requested_bbox,
                              Rect32& committed_bbox) const;
};
