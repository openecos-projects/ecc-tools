...
namespace eccdb::lef_detail::grammar::cut {
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_cutclass,
                          (std::string, _classname)(double, _via_width)(std::optional<double>, _via_length)(std::optional<int>,
                                                                                                            _num_cut)(std::string, _orient))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_enclosure,
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_enclosureedge_width,
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_orthogonal_item, (double, _within)(double, _spacing))
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_enclosureedge_convexcorners,
                          (double, _convex_length)(double, _adjacent_length)(double, _par_within)(double, _length))
using EccdbLef58_width_convex_vairant
    = boost::variant<eccdb::lef_detail::grammar::cut::lef58_enclosureedge_width, eccdb::lef_detail::grammar::cut::lef58_enclosureedge_convexcorners>;
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_enclosureedge,
                          (std::string, _classname)(std::string, _direction)(double, _overhang)(EccdbLef58_width_convex_vairant, _width_convex))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_eolenclosure_edgeoverhang, (std::string, _applied_to)(double, _overhang))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_eolenclosure_overhang,
...
using EccdbLef58_enclosure_variant
    = boost::variant<eccdb::lef_detail::grammar::cut::lef58_eolenclosure_edgeoverhang, eccdb::lef_detail::grammar::cut::lef58_eolenclosure_overhang>;

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_eolenclosure,
                          (double, _eol_width)(std::optional<double>, _min_eol_width)(std::string, _edge_direction)(
                              std::string, _equalrectwidth)(std::string, _classname)(std::string, _direction)(EccdbLef58_enclosure_variant, _overhang))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_eolspacing_toclass,
                          (std::string, _classname)(double, _cut_spacing1)(double, _cut_spacing2))
using EccdbLef58_to_class_vector = std::vector<eccdb::lef_detail::grammar::cut::lef58_eolspacing_toclass>;
BOOST_FUSION_ADAPT_STRUCT(
    eccdb::lef_detail::grammar::cut::lef58_eolspacing,
    (double, _cut_spacing1)(double, _cut_spacing2)(std::string, _classname1)(EccdbLef58_to_class_vector, _to_classes)(double, _eol_width)(
        double, _prl)(double, _smaller_overhang)(double, _equal_overhang)(double, _side_ext)(double, _backward_ext)(double, _span_length))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_classpair, (std::string, _from)(std::string, _to))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_layer,
                          (std::string, _second_layername)(std::string, _nostack)(
                              std::vector<eccdb::lef_detail::grammar::cut::lef58_spacingtable_classpair>, _prl_for_aligned_cut))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_prl_entry,
                          (std::string, _from)(std::string, _to)(double, _prl))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_prl,
                          (double, _prl)(std::string, _direction)(std::string, _maxxy)(
                              std::vector<eccdb::lef_detail::grammar::cut::lef58_spacingtable_prl_entry>, _entries))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_classname, (std::string, _classname)(std::string, _edge))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_cutspacing,
                          (std::optional<double>, _cut1)(std::optional<double>, _cut2))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_cutspacings,
                          (eccdb::lef_detail::grammar::cut::lef58_spacingtable_classname,
                           _classname2)(std::vector<eccdb::lef_detail::grammar::cut::lef58_spacingtable_cutspacing>, _cutspacings))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable_cutclass,
                          (std::vector<eccdb::lef_detail::grammar::cut::lef58_spacingtable_classname>,
                           _classname1)(std::vector<eccdb::lef_detail::grammar::cut::lef58_spacingtable_cutspacings>, _cuts))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::cut::lef58_spacingtable,
                          (std::optional<double>, _default_spacing)(std::string, _same_mask)(std::string, _same_kind)(
                              std::optional<eccdb::lef_detail::grammar::cut::lef58_spacingtable_layer>,
                           _layer)(std::optional<eccdb::lef_detail::grammar::cut::lef58_spacingtable_prl>,
                                   _prl)(eccdb::lef_detail::grammar::cut::lef58_spacingtable_cutclass, _cutclass))
