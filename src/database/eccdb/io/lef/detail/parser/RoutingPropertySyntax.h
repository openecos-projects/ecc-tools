...
using EccdbLef58_double_pair = std::pair<double, double>;
...
struct lef58_area
{
  ...
  std::vector<EccdbLef58_double_pair> _except_min_size;
  std::optional<EccdbLef58_double_pair> _except_step;
...
struct lef58_spacing_eol
{
  ...
  std::optional<EccdbLef58_double_pair> _except_exact_width;
...
{
  double _width;
  std::optional<EccdbLef58_double_pair> _except_within;
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::EccdbLef58_double_pair, (double, first)(double, second))
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_area_exceptedgelength,
                          (double, _min_edge_length)(std::optional<double>, _max_edge_length))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_area,
                          (double, _min_area)(std::optional<int>, _mask_num)(std::optional<double>, _except_min_width)(
                              std::optional<eccdb::lef_detail::grammar::routing::lef58_area_exceptedgelength>,
                              _exceptedgelength)(std::vector<eccdb::lef_detail::grammar::routing::EccdbLef58_double_pair>,
                                                 _except_min_size)(std::optional<eccdb::lef_detail::grammar::routing::EccdbLef58_double_pair>, _except_step)(
                              std::optional<double>, _rect_width)(std::string, _exceptrectangle)(std::string,
                                                                                                 _trim_layer)(std::optional<int>, _overlap))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_cornerfillspacing,
                          (double, _spacing)(double, _length1)(double, _length2)(double, _eol_width))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::name_cuts, (std::string, _class_name)(int, _num_cuts))
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_minimumcut,
                          (std::optional<int>, _num_cuts)(std::vector<eccdb::lef_detail::grammar::routing::name_cuts>,
...
BOOST_FUSION_ADAPT_STRUCT(
    eccdb::lef_detail::grammar::routing::lef58_minstep,
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacing_notchlength,
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacing_eol_withcut,
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacing_eol_endprlspacing, (double, _end_prl_space)(double, _end_prl))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacing_eol_endtoend,
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacing_eol_paralleledge,
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacing_eol_enclosecut,
                          (std::string, _direction)(double, _enclose_dist)(double, _cut_to_metal_space)(std::string, _all_cuts))
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacing_eol_toconcavecorner,
                          (std::optional<double>, _min_length)(std::optional<double>, _min_adj_length1)(std::optional<double>,
                                                                                                        _min_adj_length2))

BOOST_FUSION_ADAPT_STRUCT(
    eccdb::lef_detail::grammar::routing::lef58_spacing_eol,
    (double, _eol_space)(double, _eol_width)(std::string, _exact_width)(std::optional<double>, _wrong_dir_space)(
        ...
        std::string, _same_mask)(std::optional<eccdb::lef_detail::grammar::routing::EccdbLef58_double_pair>, _except_exact_width)(std::optional<double>,
                                                                                                              _fill_triangle)(
        std::optional<eccdb::lef_detail::grammar::routing::lef58_spacing_eol_withcut>,
        _withcut)(std::optional<eccdb::lef_detail::grammar::routing::lef58_spacing_eol_endprlspacing>,
                  _end_prl_spacing)(std::optional<eccdb::lef_detail::grammar::routing::lef58_spacing_eol_endtoend>, _end_to_end)

        (std::optional<double>, _max_length)(std::optional<double>, _min_length)(std::string, _two_sides)

            (std::string, _equal_rect_width)(std::optional<eccdb::lef_detail::grammar::routing::lef58_spacing_eol_paralleledge>, _parallel_edge)(
                std::optional<eccdb::lef_detail::grammar::routing::lef58_spacing_eol_enclosecut>,
                _enclose_cut)(std::optional<eccdb::lef_detail::grammar::routing::lef58_spacing_eol_toconcavecorner>, _toconcavecorner)

                (std::optional<double>, _notch_length)

)

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacingtable_jogtojog_width,
...
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacingtable_jogtojog,
                          (double, _jog2jog_spacing)(double, _jog_width)(double, _short_jog_spacing)(
                              std::vector<eccdb::lef_detail::grammar::routing::lef58_spacingtable_jogtojog_width>, _width))
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_cornerspacing_width, (double, _width)(double, _spacing))
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_cornerspacing,
                          (std::string, _corner_type)(std::string, _corner_to_corner)(std::optional<double>, _except_eol)(
                              std::vector<eccdb::lef_detail::grammar::routing::lef58_cornerspacing_width>, _width_spacings))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacingtable_prl_width,
                          (double, _width)(std::optional<eccdb::lef_detail::grammar::routing::EccdbLef58_double_pair>, _except_within)(
                              std::vector<double>, _spacings))
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacingtable_prl_influence,
                          (double, _width)(double, _within)(double, _spacing))
BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_spacingtable_prl,
                          (std::string, _wrong_direction)(std::string, _same_mask)(
                              ...
                              std::vector<eccdb::lef_detail::grammar::routing::lef58_spacingtable_prl_width>, _widths)(
                              std::optional<std::vector<eccdb::lef_detail::grammar::routing::lef58_spacingtable_prl_influence>>, _influences))

BOOST_FUSION_ADAPT_STRUCT(eccdb::lef_detail::grammar::routing::lef58_widthtable,
