...
class ECModel
{
 public:
  ...
  {
    _netlist_io_name_list = netlist_io_name_list;
  }
  void set_def_io_name_list(const std::vector<std::string>& def_io_name_list) { _def_io_name_list = def_io_name_list; }
  void set_netlist_instance_name_list(const std::vector<std::string>& netlist_instance_name_list)
  {
    _netlist_instance_name_list = netlist_instance_name_list;
  }
  void set_def_instance_name_list(const std::vector<std::string>& def_instance_name_list)
  {
    _def_instance_name_list = def_instance_name_list;
  }
  void set_netlist_net_name_list(const std::vector<std::string>& netlist_net_name_list)
  {
    _netlist_net_name_list = netlist_net_name_list;
  }
