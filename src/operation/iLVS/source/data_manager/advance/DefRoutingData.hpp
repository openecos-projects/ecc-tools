...
class DefRoutingData
{
 public:
  ...
  // getter
  std::unordered_map<std::string, NetRoutingData>& get_net_routing_data_map() { return _net_routing_data_map; }
  ...
  // const getter
  const std::unordered_map<std::string, NetRoutingData>& get_net_routing_data_map() const { return _net_routing_data_map; }
 ...
 private:
  std::unordered_map<std::string, NetRoutingData> _net_routing_data_map;
