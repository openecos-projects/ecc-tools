...
class PRComParam
{
 public:
  PRComParam() = default;
  PRComParam(int32_t topo_spilt_length, int32_t expand_step_num, int32_t astar_search_margin, double overflow_unit, double corner_weight = 0.3)
  {
    _topo_spilt_length = topo_spilt_length;
    _expand_step_num = expand_step_num;
    _astar_search_margin = astar_search_margin;
  ...
  int32_t get_astar_search_margin() const { return _astar_search_margin; }
  ...
  void set_astar_search_margin(const int32_t astar_search_margin) { _astar_search_margin = astar_search_margin; }
 ...
 private:
  ...
  int32_t _astar_search_margin = 0;
