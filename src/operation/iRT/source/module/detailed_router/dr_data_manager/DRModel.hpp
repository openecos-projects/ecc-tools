...
class DRModel
{
 public:
  ...
  DRIterParam& get_refine_iter_param() { return _refine_iter_param; }
  ...
  void set_refine_iter_param(const DRIterParam& dr_iter_param) { _refine_iter_param = dr_iter_param; }
 ...
 private:
  ...
  DRIterParam _refine_iter_param;
