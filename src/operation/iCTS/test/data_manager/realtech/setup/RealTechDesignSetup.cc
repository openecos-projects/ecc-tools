...
namespace icts_test::data_manager::realtech {
namespace {
...
auto CountClockLikeLoadPins(idb::IdbNet* net) -> std::size_t
{
  ...
  return static_cast<std::size_t>(
      std::ranges::count_if(net->get_load_pins(), [](idb::IdbPin* pin) -> bool { return pin != nullptr && IsClockLikePinName(pin->get_pin_name()); }));
}
...
auto MakeRealTechOrSyntheticLoads(std::size_t target_count, unsigned seed, std::string& source_label) -> data_manager::fixture::data::GeneratedPins
{
