...
#include "data_manager/realtech/load/RealTechLoadFactory.hh"
...
namespace icts_test::data_manager::realtech::load {
namespace {
...
auto MakeRealDesignLoads(std::size_t target_count, std::string& source_label, unsigned seed) -> data_manager::fixture::data::GeneratedPins
{
  data_manager::fixture::data::GeneratedPins result;
  if (target_count == 0) {
    return result;
  }
...
auto MakeSyntheticLoads(std::size_t target_count, std::string& source_label, unsigned seed) -> data_manager::fixture::data::GeneratedPins
{
  source_label = "synthetic_standin:gaussian_mixture";
  return icts_test::data_manager::fixture::data::MakeGaussianMixture(target_count, {.width = kSyntheticLoadCanvasWidth, .height = kSyntheticLoadCanvasHeight},
                                                                     seed);
}
