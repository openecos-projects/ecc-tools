...
#include "module/topology/fast_clustering/fixture/metrics/ClusterGeometryMetrics.hh"
...
namespace icts_test::module::topology::fast_clustering::fixture {
namespace {
...
auto CollectClusterMetrics(const icts::ClusterOutput& result) -> ClusterMetrics
{
  ...
  metrics.avg_cluster_size = metrics.cluster_count == 0 ? 0.0 : static_cast<double>(total_load_count) / static_cast<double>(metrics.cluster_count);
  return metrics;
}
