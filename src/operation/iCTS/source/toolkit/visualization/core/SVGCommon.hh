...
constexpr double kSinkLoadRadius = 2.0;
...
inline const std::array<const char*, 16> kPalette = {"#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f",
...
inline auto ChoosePaletteIndex(const std::vector<std::vector<std::size_t>>& adjacency, const std::vector<int>& assigned, std::size_t cluster_id) -> int
{
