...
// ***************************************************************************************
/**
 * @file HighsMathHtreeSolver.hh
 * @author Dawn Li (dawnli619215645@gmail.com)
 * @date 2026-05-26
 * @brief In-process HiGHS MILP backend for the mathematical H-tree model.
 */
...
struct HighsMathHtreeSolverOptions
{
  double anchor_time_limit_ms = 20000.0;
  double normalized_time_limit_ms = 20000.0;
};

class HighsMathHtreeSolver
{
 public:
  explicit HighsMathHtreeSolver(HighsMathHtreeSolverOptions options = {});
 ...
 private:
  HighsMathHtreeSolverOptions _options;
};
