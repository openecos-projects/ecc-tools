...
// ***************************************************************************************
/**
 * @file DomainStatusRecorder.hh
 * @author Dawn Li (dawnli619215645@gmail.com)
 * @date 2026-04-29
 * @brief Typed CTS clock-tree synthesis status recording.
 */
...
{
 public:
  explicit DomainStatusRecorder(std::vector<SynthesisTraceStatusRecord>& records) : _records(&records) {}
 ...
 private:
  std::vector<SynthesisTraceStatusRecord>* _records = nullptr;
};
