...
class SDFWriter
{
 ...
 private:
  ...
  SDFDelay getSDFArcDelay(Arc& arc);
  SDFDelay getSDFTimingArcDelay(Arc& arc, TimingArc& timing_arc);
  ...
  std::string getSDFInstanceName(Instance& instance);
  std::string getSDFName(std::string& name);
