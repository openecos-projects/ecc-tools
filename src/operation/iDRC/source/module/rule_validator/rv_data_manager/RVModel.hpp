...
class RVModel
{
 public:
  RVModel() = default;
  RVModel(std::vector<DRCShape> drc_env_shape_list, std::vector<DRCShape> drc_result_shape_list,
          std::set<ViolationType> drc_check_type_set, std::vector<DRCShape> drc_check_region_list)
      : _drc_env_shape_list(std::move(drc_env_shape_list)),
        _drc_result_shape_list(std::move(drc_result_shape_list)),
        _drc_check_type_set(std::move(drc_check_type_set)),
        _drc_check_region_list(std::move(drc_check_region_list))
  {
  }
  ~RVModel() = default;
  // getter
  ...
  std::vector<RVCluster>& get_rv_group_cluster_list() { return _rv_group_cluster_list; }
  std::vector<std::vector<int32_t>>& get_rv_cluster_group_list() { return _rv_cluster_group_list; }
  ...
  void set_rv_group_cluster_list(std::vector<RVCluster>&& rv_group_cluster_list) { _rv_group_cluster_list = std::move(rv_group_cluster_list); }
 ...
 private:
  ...
  std::vector<RVCluster> _rv_group_cluster_list;
